...
class MoE(nn.Module):
    ...
    def forward(self, x):
        ...
        return output, select0, balance_loss  
...
class MV_MOE(nn.Module):
    ...
    def forward(self, x_set):
        ...
        for num in range(self.view_num):
            output, select0, balance_loss = self.moe(middle_set[num])
        ...
        return fused_h, reconstructed_x, sum_balance_loss, expert_distinctive_loss
